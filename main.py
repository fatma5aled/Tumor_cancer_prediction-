...
concavity_mean=st.number_input(bold_label("write your concavity_mean"))
concave_points_mean=st.number_input(bold_label("write your concave_points_mean"))
concavity_worst=st.number_input(bold_label("write your concavity_worst"))
perimeter_worst=st.number_input(bold_label("write your perimeter_worst"))
concave_points_worst=st.number_input(bold_label("write your concave_points_worst"))
